...
**This document is not part of the Agent Contracts Standard.** It describes how **this publication** (`agent-contracts-standard`) ships the normative spec file alongside templates, examples, and supporting docs. ACS compliance for **other** repositories is defined **only** by the normative sections of `spec/ACS-v0.1.md` (Sections 1–10).
...
The `mcp-tool-contract.json` file is an optional **documentation mirror** of the MCP tool descriptor shape from the normative spec Section 3; live tools are still defined in MCP configuration.
