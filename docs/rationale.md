...
- **Strict dogfood:** The reference repository can carry a full `.ai/` maintainer contract and automated checks (`scripts/Verify-AcsRepo.ps1`) so the standard’s publisher eats its own cooking at a higher bar than the §1.8 minimum alone.
