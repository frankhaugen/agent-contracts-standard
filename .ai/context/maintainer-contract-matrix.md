...
|----------|-----------|-----------|
| Instructions | Editorial rules for §1/§2, BCP 14, refs, parity | `maintaining-the-spec.md`, `bcp14-requirement-keywords.md`, `normative-vs-informative.md`, `normative-references-maintenance.md`, `templates-examples-parity.md` |
| Policies | Hard gates (integrity, discoverability, vendor neutrality, changelog) | `spec-integrity.md`, `discoverability-from-agents.md`, `vendor-neutrality-contracts.md`, `changelog-for-normative-changes.md` |
