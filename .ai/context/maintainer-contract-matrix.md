...
|----------|-----------|-----------|
| Instructions | Editorial rules for the normative spec, BCP 14, refs, parity, spec gate | `maintaining-the-spec.md`, `bcp14-requirement-keywords.md`, `normative-vs-informative.md`, `normative-references-maintenance.md`, `templates-examples-parity.md`, `spec-change-gate.md` |
...
**Resolution order** when loading contracts: `AGENTS.md` → `.ai/index.md` → instructions → policies → skills → commands → context (`spec/ACS-v0.1.md` Section 8).
