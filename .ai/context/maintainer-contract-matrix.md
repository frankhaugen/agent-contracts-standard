...
|----------|-----------|-----------|
| Instructions | Editorial rules for §1, BCP 14, refs, parity, spec gate | `maintaining-the-spec.md`, `bcp14-requirement-keywords.md`, `normative-vs-informative.md`, `normative-references-maintenance.md`, `templates-examples-parity.md`, `spec-change-gate.md` |
