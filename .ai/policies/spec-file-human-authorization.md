...
The specification document is the **contract for the ecosystem**. Silent or agent-initiated edits undermine trust and versioning. This policy is **stricter** than ACS Section 9 and exists only for **this** publication workflow.
