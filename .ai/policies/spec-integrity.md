...
2. **MUST** update [`docs/publisher-layout-and-templates.md`](../../docs/publisher-layout-and-templates.md), `templates/`, `examples/`, and root `.ai/` when §1.4 (required structure) or §1.6 (contract definitions) changes, in the **same** change set when practical.
