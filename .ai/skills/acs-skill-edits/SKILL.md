...
1. Conform to **[AGENT-SKILLS]** (`spec/ACS-v0.1.md` Section 10): `name` **MUST** match parent directory; `description` 1–1024 chars with trigger keywords.
...
For normative spec edits use [acs-normative-edit](../acs-normative-edit/SKILL.md); for template/example sync use [acs-sync-templates-examples](../acs-sync-templates-examples/SKILL.md).
