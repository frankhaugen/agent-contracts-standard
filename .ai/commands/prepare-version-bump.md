...
4. Sync `docs/publisher-layout-and-templates.md`, `templates/`, `examples/`, and `scripts/verify_acs_repo.py` expectations.
5. Run `python3 scripts/verify_acs_repo.py` and CI.
